To get started, make sure you have create-react-app installed on your machine. If not, install it with ```npm i -g create-react-app``` If you would prefer not to install the package globally, do not prepend 
